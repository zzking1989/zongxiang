        ...
        <form id="registerForm">
            ...
            <div class="form-group" style="width: 400px;text-align: left">
                ...
                <input type="password" class="form-control" style="width: 400px"
                       ...
                       placeholder="请输入密码">
                <span class="span1" id="passwordSpan" style="color: brown" hidden>密码不能为空！</span>
            </div>
            <div class="form-group" style="width: 400px;text-align: left">
                <label>重复密码：</label>
                <input type="text" class="form-control" style="width: 400px"
                       ...
                       name="repeatPassword"
                       placeholder="请输入名称">
                <span class="span1" id="repeatPasswordSpan" style="color: brown" hidden>重复密码不能为空！</span>
            </div>
            <div class="form-group" style="width: 400px;">
                <button type="button" class="btn btn-primary" onclick="register()" style="width: 100px">提交</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    function register() {
        ...
        if (loginFormValues.elements[0].value == "") {
            ...
            $("#passwordSpan").show();
        } else if (loginFormValues.elements[2].value == "") {
            $("#repeatPasswordSpan").show();
        } else if (loginFormValues.elements[1].value != loginFormValues.elements[2].value) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.code1 == 1) {
                        ...
                        $("#usernameSpan").html(result.name1);
                    }
                },
                error: function () {
                    alert("异常！");
